package com.example.pasteles_de_milsabores.ui.screens
...
fun PostScreen(viewModel: PostViewModel) {
    //Observamos el flujo de datos de viewModel
    ...
    Scaffold(
        ...
        Box(modifier = Modifier
            .fillMaxSize()
            .padding(innerPadding) //Esto asegura el uso de edge-to-edge
        ) {
            //List de publicaciones
            LazyColumn (
                modifier = Modifier
                    .fillMaxSize()
